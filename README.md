...
<ul>
  ...
  <li><a href="https://github.com/abircb/quickbuild/tree/master/templates/Django-React%20Application">Django-React application</a>: A Django project boilerplate with state of the art libraries and tools (like React, Bootstrap 4, Webpack, Celery, and more) for building modern web applications.</li>
  ...
  <li><a href="https://github.com/abircb/quickbuild/tree/master/templates/TypeScript%20Node">Typescript-Node Web application</a>: A starter template with a good end-to-end project setup and workflow for writing Node code in TypeScript</li>
