...
export async function generateLicense(options) {
  if (
    (options.license_MIT && options.license_Apache) ||
    (options.license_MIT && options.license_BSD) ||
    (options.license_BSD && options.license_Apache)
  ) {
    ...
    if (options.license_MIT || options.license === 'MIT License') {
      ...
      options.license === 'Apache License 2.0'
    ) {
