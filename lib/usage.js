...
export function usageInfo () {
  ...
  console.log('    --quickestbuild, -q   create generic boilerplate')
  console.log('    --name, -n            enter your project name')
  console.log('    --install, -i         install project dependencies')
  console.log('    --git, -g             initialize git')
  console.log('    --mit                 add MIT license')
  console.log('    --apache              add Apache 2.0 license')
  console.log('    --bsd                 add BSD 2-Clause license')
  console.log('    --unlicensed, -u      create an unlicensed project\n')
