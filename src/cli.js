...
async function promptForMissingOptions (options) {
  ...
  if (!options.template) {
    questions.push({
      ...
      choices: ['AngularJS App', 'Atom UI', 'Chrome Extension', 'Firefox Extension', 'Crossover Extension', 'Electron App Quick Start', 'Electron App (Advanced)', 'ECMAScript 6', 'Express.js server', 'jQuery Plugin', 'Node.js server (advanced)', 'Node.js server', 'React-Redux', 'React', 'Static Webpage', 'Typescript'],
